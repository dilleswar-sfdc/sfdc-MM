    ...
    {        
        ...
        action.setCallback(this, function(response) {
            ...
            if (state === "SUCCESS")
            {
                ...
                window.name = '{"btnname":"Create AMP Sales Materials","isQuickaction":"true","playbookurl":"'+data.result.url.playbook+'","printurl":"'+data.result.url.print+'","ebookurl":"'+data.result.url.ebook+'","weburl":"'+data.result.url.web+'","tabname":"createlead"}';
