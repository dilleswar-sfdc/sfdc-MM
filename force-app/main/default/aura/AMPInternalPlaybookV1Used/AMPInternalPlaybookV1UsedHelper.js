({
    ...
    callApi : function(component, helper,method,itemid,comment)
    {
        ...
        component.set("v.paginatedisplay",false);
        ...
        var state = response.getState();
            ...
            if(state === "SUCCESS")
            {
        		...
        		toastEvent.fire();
                    ...
                    if(finalresponse==false)
                     {
                         $(".internalPlaybooksection").html("<div class='slds-box'>Sorry!"+' '+finalmessage+"</div>");
                        var toastEvent = $A.get("e.force:showToast");
                             toastEvent.setParams({
                            title : 'Info Message',
                            message: finalmessage,
                        ...
                        component.set("v.paginatedisplay",true);
    ...
    dynamicColorBinding : function(component,event,helper){
        document.documentElement.style.setProperty('--playbookwidth', component.get("v.playbookwidth")+'px');
       	component.find('dynamicPlaybookColor').set('v.style','--mainnavbgcolor:'+component.get('v.mainnavbgcolor')+';');
	},
})